package ua.valeriishymchuk.backpacks.common.configuration.builder;
...
import ua.valeriishymchuk.backpacks.common.configuration.IConfigLoaderConfigurator;
        ...
        <L extends AbstractConfigurationLoader<?>, B extends AbstractConfigurationLoader.Builder<B, L>>
{
    ...
    public IConfigLoaderConfigurator build() {
        ...
        return new IConfigLoaderConfigurator() {
            @Override
            public ConfigurationLoader<?> configure(File file) {
